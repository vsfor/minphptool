...
/**
 * 重构了部分方法
 * based on composer package mk-j/php_xlsxwriter
 * @see https://packagist.org/packages/mk-j/php_xlsxwriter
 *
 * basic usage:
    $data = array(
...
class XLSXWriter
{
    ...
    public function setTempDir($tempDir='') { $this->tempDir=$tempDir; return $this;}
    public function setRightToLeft($isRightToLeft=false){ $this->isRightToLeft=$isRightToLeft; return $this;}
